...
#define	PB05                           5U
#define	PB06                           6U
#define	PB07_HIGH_TP_RX                7U
#define	PB08                           8U
#define	PB09                           9U
#define	PB10_HIGH_TP_TX                10U
#define	PB11                           11U
#define	PB12                           12U
#define	PB13                           13U
#define	PB14                           14U
...
#define	LINE_HIGH_TP_RX                PAL_LINE(GPIOB, 7U)
#define	LINE_HIGH_TP_TX                PAL_LINE(GPIOB, 10U)
...
#define VAL_GPIOB_MODER                 (PIN_MODE_INPUT(PB00) | \
					 ...
					 PIN_MODE_INPUT(PB05) | \
					 PIN_MODE_INPUT(PB06) | \
					 PIN_MODE_ALTERNATE(PB07_HIGH_TP_RX) | \
					 PIN_MODE_INPUT(PB08) | \
					 PIN_MODE_INPUT(PB09) | \
					 PIN_MODE_ALTERNATE(PB10_HIGH_TP_TX) | \
					 PIN_MODE_INPUT(PB11) | \
					 PIN_MODE_INPUT(PB12) | \
					 PIN_MODE_INPUT(PB13) | \
					 PIN_MODE_INPUT(PB14) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(PB00) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PB07_HIGH_TP_RX) | \
					 PIN_OTYPE_PUSHPULL(PB08) | \
					 PIN_OTYPE_PUSHPULL(PB09) | \
					 PIN_OTYPE_PUSHPULL(PB10_HIGH_TP_TX) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PB00) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PB07_HIGH_TP_RX) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB08) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB09) | \
					 PIN_OSPEED_SPEED_HIGH(PB10_HIGH_TP_TX) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_PULLDOWN(PB00) | \
					 ...
					 PIN_PUPDR_FLOATING(PB07_HIGH_TP_RX) | \
					 PIN_PUPDR_PULLDOWN(PB08) | \
					 PIN_PUPDR_PULLDOWN(PB09) | \
					 PIN_PUPDR_FLOATING(PB10_HIGH_TP_TX) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(PB00) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PB07_HIGH_TP_RX) | \
					 PIN_ODR_LEVEL_LOW(PB08) | \
					 PIN_ODR_LEVEL_LOW(PB09) | \
					 PIN_ODR_LEVEL_HIGH(PB10_HIGH_TP_TX) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00, 0) | \
					 ...
					 PIN_AFIO_AF(PB05, 0) | \
					 PIN_AFIO_AF(PB06, 0) | \
					 PIN_AFIO_AF(PB07_HIGH_TP_RX, 7))

#define VAL_GPIOB_AFRH			(PIN_AFIO_AF(PB08, 0) | \
					 PIN_AFIO_AF(PB09, 0) | \
					 PIN_AFIO_AF(PB10_HIGH_TP_TX, 7) | \
					 PIN_AFIO_AF(PB11, 0) | \
					 PIN_AFIO_AF(PB12, 0) | \
					 PIN_AFIO_AF(PB13, 0) | \
					 PIN_AFIO_AF(PB14, 0) | \
...
#define AF_PB07_HIGH_TP_RX               7U
#define AF_LINE_HIGH_TP_RX               7U
#define AF_PB10_HIGH_TP_TX               7U
#define AF_LINE_HIGH_TP_TX               7U

...
#define	PA03_SHELL_RX                  3U
#define	PA04                           4U
#define	PA05                           5U
#define	PA06                           6U
#define	PA07                           7U
#define	PA08_LED2812_CH1               8U
#define	PA09                           9U
#define	PA10_LED2812_CH3               10U
#define	PA11                           11U
#define	PA12                           12U
...
#define	PD13_LED2                      13U
#define	PD14_LED3                      14U
#define	PD15_LED4                      15U
...
#define	PE09                           9U
#define	PE10                           10U
#define	PE11_LED2812_CH2               11U
#define	PE12                           12U
#define	PE13                           13U
#define	PE14_LED2812_CH4               14U
#define	PE15                           15U
...
#define	LINE_SHELL_RX                  PAL_LINE(GPIOA, 3U)
#define	LINE_LED2812_CH1               PAL_LINE(GPIOA, 8U)
#define	LINE_LED2812_CH3               PAL_LINE(GPIOA, 10U)
...
#define	LINE_LED2812_CH2               PAL_LINE(GPIOE, 11U)
#define	LINE_LED2812_CH4               PAL_LINE(GPIOE, 14U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_INPUT(PA00_BLUE_BUTTON) | \
					 ...
					 PIN_MODE_ALTERNATE(PA03_SHELL_RX) | \
					 PIN_MODE_INPUT(PA04) | \
					 PIN_MODE_INPUT(PA05) | \
					 PIN_MODE_INPUT(PA06) | \
					 PIN_MODE_INPUT(PA07) | \
					 PIN_MODE_ALTERNATE(PA08_LED2812_CH1) | \
					 PIN_MODE_INPUT(PA09) | \
					 PIN_MODE_ALTERNATE(PA10_LED2812_CH3) | \
					 PIN_MODE_INPUT(PA11) | \
					 PIN_MODE_INPUT(PA12) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00_BLUE_BUTTON, 0) | \
					 ...
					 PIN_AFIO_AF(PA03_SHELL_RX, 7) | \
					 PIN_AFIO_AF(PA04, 0) | \
					 PIN_AFIO_AF(PA05, 0) | \
					 PIN_AFIO_AF(PA06, 0) | \
					 PIN_AFIO_AF(PA07, 0))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_LED2812_CH1, 1) | \
					 PIN_AFIO_AF(PA09, 0) | \
					 PIN_AFIO_AF(PA10_LED2812_CH3, 1) | \
					 PIN_AFIO_AF(PA11, 0) | \
					 PIN_AFIO_AF(PA12, 0) | \
...
#define VAL_GPIOD_MODER                 (PIN_MODE_INPUT(PD00) | \
					 ...
					 PIN_MODE_OUTPUT(PD13_LED2) | \
					 PIN_MODE_OUTPUT(PD14_LED3) | \
					 PIN_MODE_OUTPUT(PD15_LED4))
...
#define VAL_GPIOD_OTYPER                (PIN_OTYPE_PUSHPULL(PD00) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PD13_LED2) | \
					 PIN_OTYPE_PUSHPULL(PD14_LED3) | \
					 PIN_OTYPE_PUSHPULL(PD15_LED4))
...
#define VAL_GPIOD_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PD00) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PD13_LED2) | \
					 PIN_OSPEED_SPEED_VERYLOW(PD14_LED3) | \
					 PIN_OSPEED_SPEED_VERYLOW(PD15_LED4))
...
#define VAL_GPIOD_PUPDR                 (PIN_PUPDR_PULLDOWN(PD00) | \
					 ...
					 PIN_PUPDR_FLOATING(PD13_LED2) | \
					 PIN_PUPDR_FLOATING(PD14_LED3) | \
					 PIN_PUPDR_FLOATING(PD15_LED4))
...
#define VAL_GPIOD_ODR                   (PIN_ODR_LEVEL_LOW(PD00) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PD13_LED2) | \
					 PIN_ODR_LEVEL_LOW(PD14_LED3) | \
					 PIN_ODR_LEVEL_LOW(PD15_LED4))
...
#define VAL_GPIOD_AFRH			(PIN_AFIO_AF(PD08, 0) | \
					 ...
					 PIN_AFIO_AF(PD13_LED2, 0) | \
					 PIN_AFIO_AF(PD14_LED3, 0) | \
					 PIN_AFIO_AF(PD15_LED4, 0))
...
#define VAL_GPIOE_MODER                 (PIN_MODE_INPUT(PE00) | \
					 ...
					 PIN_MODE_INPUT(PE09) | \
					 PIN_MODE_INPUT(PE10) | \
					 PIN_MODE_ALTERNATE(PE11_LED2812_CH2) | \
					 PIN_MODE_INPUT(PE12) | \
					 PIN_MODE_INPUT(PE13) | \
					 PIN_MODE_ALTERNATE(PE14_LED2812_CH4) | \
					 PIN_MODE_INPUT(PE15))
...
#define VAL_GPIOE_OTYPER                (PIN_OTYPE_PUSHPULL(PE00) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PE11_LED2812_CH2) | \
					 PIN_OTYPE_PUSHPULL(PE12) | \
					 PIN_OTYPE_PUSHPULL(PE13) | \
					 PIN_OTYPE_PUSHPULL(PE14_LED2812_CH4) | \
...
#define VAL_GPIOE_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PE00) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PE11_LED2812_CH2) | \
					 PIN_OSPEED_SPEED_VERYLOW(PE12) | \
					 PIN_OSPEED_SPEED_VERYLOW(PE13) | \
					 PIN_OSPEED_SPEED_HIGH(PE14_LED2812_CH4) | \
...
#define VAL_GPIOE_PUPDR                 (PIN_PUPDR_PULLDOWN(PE00) | \
					 ...
					 PIN_PUPDR_FLOATING(PE11_LED2812_CH2) | \
					 PIN_PUPDR_PULLDOWN(PE12) | \
					 PIN_PUPDR_PULLDOWN(PE13) | \
					 PIN_PUPDR_FLOATING(PE14_LED2812_CH4) | \
...
#define VAL_GPIOE_ODR                   (PIN_ODR_LEVEL_LOW(PE00) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PE11_LED2812_CH2) | \
					 PIN_ODR_LEVEL_LOW(PE12) | \
					 PIN_ODR_LEVEL_LOW(PE13) | \
					 PIN_ODR_LEVEL_LOW(PE14_LED2812_CH4) | \
...
#define VAL_GPIOE_AFRH			(PIN_AFIO_AF(PE08, 0) | \
					 PIN_AFIO_AF(PE09, 0) | \
					 PIN_AFIO_AF(PE10, 0) | \
					 PIN_AFIO_AF(PE11_LED2812_CH2, 1) | \
					 PIN_AFIO_AF(PE12, 0) | \
					 PIN_AFIO_AF(PE13, 0) | \
					 PIN_AFIO_AF(PE14_LED2812_CH4, 1) | \
					 PIN_AFIO_AF(PE15, 0))
...
#define AF_PA03_SHELL_RX                 7U
#define AF_LINE_SHELL_RX                 7U
#define AF_PA08_LED2812_CH1              1U
#define AF_LINE_LED2812_CH1              1U
#define AF_PA10_LED2812_CH3              1U
#define AF_LINE_LED2812_CH3              1U
...
#define AF_PE11_LED2812_CH2              1U
#define AF_LINE_LED2812_CH2              1U
#define AF_PE14_LED2812_CH4              1U
#define AF_LINE_LED2812_CH4              1U
